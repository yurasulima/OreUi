...
public enum class OreThemeVariant { Dark, Light }
...
private fun OreTypographyScheme.toMaterial(): androidx.compose.material3.Typography =
...
public fun OreTheme(
    ...
    val colors = OreColors.Amethyst
    val typography = OreTypography.default()
